...
wikipedia_link = "https://en.wikipedia.org/wiki/List_of_countries_by_number_of_military_and_paramilitary_personnel"
...
billionaires_table = soup.find("table", class_="wikitable sortable static-row-numbers plainrowheaders srn-white-background")
